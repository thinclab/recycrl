...
"""
This script trains a policy with the true reward function in the environment
"""
...
def train(
    ...
    try:
        ...
        reward_model = env.unwrapped.reward_model
        ...
        for _ in range(training_steps):
            # Train the RL model
            rl.train_for_buffalo(reward_model, online=True, alpha=alpha, beta=beta, step=step, max_delta=max_delta)
...
if __name__ == "__main__":
    ...
    description = "This script trains a policy with the true reward function in the environment"
